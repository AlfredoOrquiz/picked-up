...
socket.on('ride-accepted', (payload) => console.log(payload.message));
// socket.on('transit-to-rider', (payload) => console.log('driver on his way!'));
socket.on('arrival-at-rider', (payload) => console.log(payload.message));
...
//   console.log('You have arrived to your destination')
// );
